...
function onPageReady() {
    var htmlContent = page.evaluate(function () {
        ...
        document.querySelector("input[name='email']").value = "dengi@yahoo.com";
        ...
        document.querySelector("select[name='birth_date_year']").value = 1946;
        ...
        document.querySelector("input[name='ssn']").value = "078051120";
        ...
        document.querySelector("input[name='pay_date1']").value = "07/05/2016";
        document.querySelector("input[name='pay_date2']").value = "08/05/2016";
        ...
        var element = document.querySelector("select[name='birth_date_month']")[3];
